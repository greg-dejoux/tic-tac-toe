...
def checkifwon ():
    ...
    if b1 ["text"] == "X" and b2 ["text"] == "X" and b3 ["text"] == "X":
        ...
        b3.config(bg="green")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Bravo, le joueur X a gagné !")
        disable_buttons()
        ...
        disable_buttons()
         ...
         b3.config(bg="green")
         winner = True
         messagebox.showinfo("Tic Tac Toe", "Bravo, le joueur O a gagné !")
         disable_buttons()
...
if count == 9 and winner == False:
    messagebox.showinfo("Tic Tac Toe", "Égalité le couzz !")
    disable_buttons()

#fonction clique boutons
def b_click(b):
    ...
    else: messagebox.showinfo("Tic Tac Toe", "Cette case est déja utilisée, choisis en une autre")
